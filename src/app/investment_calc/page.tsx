...
//2024074 make the investment cal mobile responsive 
  return (
    <Box className="container mx-auto" style={{ paddingLeft: '5%', paddingRight: '5%', paddingTop: '5%' }}>
      {flowMode === FlowMode.START && <Welcome onStart={() => setFlowMode(FlowMode.STEPPER)} />}
      {flowMode === FlowMode.STEPPER && (
        <Grid container spacing={5} className="overflow-auto">
          <Grid item xs={12}>
            <Stepper
              steps={steps}
              data={{ data }}
